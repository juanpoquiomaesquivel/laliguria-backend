package juanp.laliguria.warehouse.model;
...
@SqlResultSetMapping(name = "Mapping.SupplyRequestDTO", classes = @ConstructorResult(targetClass = SupplyRequestDTO.class, columns = {
		...
		@ColumnResult(name = "Status", type = Integer.class), @ColumnResult(name = "Area", type = Integer.class),
		@ColumnResult(name = "Registration"), @ColumnResult(name = "Requester") }))
...
@SqlResultSetMapping(name = "Mapping.DgSupplyRequestSeeDataDTO", classes = @ConstructorResult(targetClass = DgSupplyRequestSeeDataDTO.class, columns = {
		@ColumnResult(name = "Name"), @ColumnResult(name = "Description"),@ColumnResult(name = "RequestedQuantity", type = Integer.class),
